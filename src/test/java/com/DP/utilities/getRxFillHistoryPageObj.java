package com.DP.utilities;
	...
	public class getRxFillHistoryPageObj {
	...
	/*** Function to copy string ***/
	 ...
	 public static  void sendSoapRequest(String SOAPUrl, String Request) throws Exception {
	 	...
	 	public static List<String> Response_xmlparse_Validate(String[] ExcelData){
			...
			NodeList nList1 = doc.getElementsByTagName("doGetRXFillHistoryDetailsReturn");
			System.out.println("----------------------------");
			...
			for (int temp1 = 0; temp1 < count1; temp1++) 
			{
				...
				Node nodes = doc.getElementsByTagName("doGetRXFillHistoryDetailsReturn").item(temp1);
		...
		/** Function to change the Fill date format**/
	 	...
	 	public static void Request_xmlparse_Modify(String[] dataFromExcel ){
	 	   ...
	 	   try {	
	 	      ...
	 	      File inputFile = new File("data//doGetRXFillHistory_Request.xml");
	 	      DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
	 			DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
	 			Document doc = dBuilder.parse(inputFile);
	 			doc.getDocumentElement().normalize();
	 			...
	 			StreamResult result = new StreamResult("doGetRXFillHistory_ModifiedRequest.xml");
